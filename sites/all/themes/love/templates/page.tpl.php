    ...
    <div class="main-content span4">
        ...
        <div class="site-des">
          ...
          <ul>
            ...
            <li><embed type="application/x-shockwave-flash" width="290" height="24" src="<?php echo drupal_get_path('module','love')?>/player.swf?soundFile=http://liangyou.nissigz.com/media/se/se<?php echo date("ymd");?>.mp3&amp;bg=0xCDDFF3&amp;leftbg=0x357DCE&amp;lefticon=0xF2F2F2&amp;rightbg=0x357DCE&amp;rightbghover=0x4499EE&amp;righticon=0xF2F2F2&amp;righticonhover=0xFFFFFF&amp;text=0x357DCE&amp;slider=0x357DCE&amp;track=0xFFFFFF&amp;border=0xFFFFFF&amp;loader=0x8EC2F4&amp;autostart=yes&amp;loop=no" wmode="transparent" quality="high"><a href="#" rel="tooltip" title="未收到邀请？听听这个节目，预备自己成为理想的另一半吧！"><<简介</a>
</li>          </ul>
        </div>
      </div>
   </div>
