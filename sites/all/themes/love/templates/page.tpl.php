  ...
  <div class="row-fluid clearfix">
    ...
    <div class="main-content span4">
        ...
        <div class="site-des">
          <p>&nbsp;&nbsp;</p>
          <ul>
            <li>异象：爱是永不止息，是互相激励、共同成长，并且需要公众见证、公开交往，接受监督的，让更多的肢体在婚恋交友，及组建家庭上彰显神的荣耀。<a href="#" rel="tooltip" data-placement="bottom" title="【永不止息】是@bluesky_still透过对当前教会单身肢体需求的看见，在婚恋社交网络切身体验基础上，业余时间开发的针对主内肢体婚恋社交网站，通过简洁的关系建立渠道，熟人的推荐，舆论监督与指导，为肢体提供一个便捷互相了解、信实互动的社交平台。">成长历程</a></li>
            ...
            <li><embed type="application/x-shockwave-flash" width="290" height="24" 

src="<?php echo drupal_get_path('module','love')?>/player.swf?

soundFile=http://118.26.57.12:83/1Q2W3E4R5T6Y7U8I9O0P1Z2X3C4V5B/liangyou.nissigz.com/media/se/se<?php echo date("ymd");?>.mp3&amp;bg=0xCDDFF3&amp;leftbg=0x357DCE&amp;lefticon=0xF2F2F2&amp;rightbg=0x357DCE&amp;righ

tbghover=0x4499EE&amp;righticon=0xF2F2F2&amp;righticonhover=0xFFFFFF&amp;text=0x357DCE&amp;slider=

0x357DCE&amp;track=0xFFFFFF&amp;border=0xFFFFFF&amp;loader=0x8EC2F4&amp;autostart=yes&amp;loop=no" 

wmode="transparent" quality="high"><a href="#" rel="tooltip" title="未收到邀请？听听这个节目，预备自己成为理想的另一半吧！"><<简介</a>
</li>          </ul>
        </div>
      </div>
   </div>
