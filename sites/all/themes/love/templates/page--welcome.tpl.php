    ...
    <div class="main-content span4">
        ...
        <div class="site-des">
          ...
          <ul>
            ...
            <li>为<a href="#" rel="tooltip" title="请为本站营造良好的社交环境。<br/>为教会单身守望。">本站代祷</a> ，<a href="https://me.alipay.com/guoxiangke" target="_blank" rel="tooltip" title="如果您觉得打开速度慢，那么您可以在网站服务器升级上有分">支持奉献</a>，<a href="#" rel="tooltip" title="打开速度慢，这个建议就不用提了^_^">意见建议</a>，<a href="#" rel="tooltip" data-placement="top" title="【永不止息】是@bluesky_still透过对当前教会单身肢体需求的看见，业余时间开发的针对主内肢体婚恋社交网站，通过简洁的关系建立渠道，熟人的推荐，舆论监督与指导，为肢体提供一个便捷互相了解、信实互动的社交平台。">成长历程</a></li>
