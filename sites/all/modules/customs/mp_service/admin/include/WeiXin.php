...
class WeiXin
{
	...
	public function getLatestMsgs($page = 0) {
		...
		$frommsgid = 100000000;
		$offset = 50 * $page;
		$url = "https://mp.weixin.qq.com/cgi-bin/message?t=message/list&action=&keyword=&frommsgid=$frommsgid&offset=$offset&count=50&day=7&token={$this->webToken}&lang=zh_CN";
